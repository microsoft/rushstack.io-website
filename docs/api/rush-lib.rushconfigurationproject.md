...
|  [unscopedTempProjectName](./rush-lib.rushconfigurationproject.unscopedtempprojectname.md) |  | string | The unscoped temporary project nameExample: <code>my-project-2</code> |
