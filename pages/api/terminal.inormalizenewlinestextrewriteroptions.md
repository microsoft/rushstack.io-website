...
|  --- | --- | --- |
|  [ensureNewlineAtEnd](./terminal.inormalizenewlinestextrewriteroptions.ensurenewlineatend.md) | boolean | If <code>true</code>, then <code>NormalizeNewlinesTextRewriter.close()</code> will append a newline to the output if it ends with an incomplete line. |
