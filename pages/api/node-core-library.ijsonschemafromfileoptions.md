...
|  --- | --- | --- |
|  [dependentSchemas](./node-core-library.ijsonschemafromfileoptions.dependentschemas.md) | [JsonSchema](./node-core-library.jsonschema.md)<!-- -->\[\] | Other schemas that this schema references, e.g. via the "$ref" directive. |
