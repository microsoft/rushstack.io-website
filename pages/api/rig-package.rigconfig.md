...
|  [projectFolderPath](./rig-package.rigconfig.projectfolderpath.md) |  | string | The project folder path that was passed to [RigConfig.loadForProjectFolder()](./rig-package.rigconfig.loadforprojectfolder.md)<!-- -->. |
