...
|  --- | --- | --- |
|  [throwIfNotExists](./node-core-library.ifilesystemdeletefileoptions.throwifnotexists.md) | boolean | If true, will throw an exception if the file did not exist before <code>deleteFile()</code> was called. |
