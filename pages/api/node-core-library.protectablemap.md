...
|  --- | --- | --- | --- |
|  [protectedView](./node-core-library.protectablemap.protectedview.md) |  | <code>Map</code><code>&lt;K, V&gt;</code> | The owner of the protectable map should return this object via its public API. |
