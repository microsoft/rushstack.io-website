...
|  --- | --- | --- | --- |
|  [environmentVariables](./rush-lib.packagemanageroptionsconfigurationbase.environmentvariables.md) |  | <code>IConfigurationEnvironment</code> | Enviroment variables for the package manager |
