...
|  [stdio](./node-core-library.iexecutablespawnsyncoptions.stdio.md) | <code>ExecutableStdioMapping</code> | The stdio mappings for the child process.<!-- -->NOTE: If IExecutableSpawnSyncOptions.input is provided, it will take precedence over the stdin mapping (stdio\[0\]). |
