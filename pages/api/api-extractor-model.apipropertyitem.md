...
|  [propertyTypeExcerpt](./api-extractor-model.apipropertyitem.propertytypeexcerpt.md) |  | <code>Excerpt</code> | An [Excerpt](./api-extractor-model.excerpt.md) that describes the type of the property. |
